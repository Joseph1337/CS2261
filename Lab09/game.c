...
void updatePlayer() {
    ...
    if(BUTTON_HELD(BUTTON_UP)) {
        if (pikachu.worldRow > 0  && collisionmapBitmap[OFFSET(pikachu.worldCol, pikachu.worldRow - pikachu.rdel, MAPWIDTH)]
        && collisionmapBitmap[OFFSET(pikachu.worldCol + pikachu.width - pikachu.cdel, pikachu.worldRow - pikachu.rdel, MAPWIDTH)]/*Delete that 1, then:
    ...
    if(BUTTON_HELD(BUTTON_DOWN)) {
        if (pikachu.worldRow + pikachu.height < MAPHEIGHT && collisionmapBitmap[OFFSET(pikachu.worldCol, pikachu.worldRow + pikachu.height, MAPWIDTH)]
        && collisionmapBitmap[OFFSET(pikachu.worldCol + pikachu.width - pikachu.cdel, pikachu.worldRow + pikachu.height, MAPWIDTH)]/*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
            // Update pikachu's world position if the above is true
            pikachu.worldRow += pikachu.rdel;
            ...
            if (vOff + SCREENHEIGHT < MAPHEIGHT && pikachu.worldRow - vOff >= SCREENHEIGHT/2 /*Delete that 1, then:
                for TODO 1.0, make sure the background offset doesn't show past the edge,
                and only update the offset variables if pikachu is in the right spot*/) {
                // Update background offset variable if the above is true
                vOff++;
    ...
    if(BUTTON_HELD(BUTTON_LEFT)) {
        if (pikachu.worldCol > 0 && collisionmapBitmap[OFFSET(pikachu.worldCol - pikachu.cdel, pikachu.worldRow, MAPWIDTH)]
        && collisionmapBitmap[OFFSET(pikachu.worldCol - pikachu.cdel, pikachu.worldRow + pikachu.height - pikachu.rdel, MAPWIDTH)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
            ...
            if (hOff > 0 && pikachu.worldCol - hOff <= SCREENWIDTH/2 /*Delete that 1, then:
                for TODO 1.0, make sure the background offset doesn't show past the edge,
                and only update the offset variables if pikachu is in the right spot*/) {
                // Update background offset variable if the above is true
                hOff--;
    ...
    if(BUTTON_HELD(BUTTON_RIGHT)) {
        if (pikachu.worldCol + pikachu.width < MAPWIDTH && collisionmapBitmap[OFFSET(pikachu.worldCol + pikachu.width, pikachu.worldRow, MAPWIDTH)]
        && collisionmapBitmap[OFFSET(pikachu.worldCol + pikachu.width, pikachu.worldRow + pikachu.height - pikachu.rdel, MAPWIDTH)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
            ...
            if (hOff + SCREENWIDTH < MAPWIDTH && pikachu.worldCol - hOff >= SCREENWIDTH/2 /*Delete that 1, then:
                for TODO 1.0, make sure the background offset doesn't show past the edge,
                and only update the offset variables if pikachu is in the right spot*/) {
                // Update background offset variable if the above is true
                hOff++;
...
void drawPlayer() {
    ...
    if (pikachu.hide) {
        ...
        shadowOAM[0].attr1 = (COLMASK & pikachu.worldCol - hOff /* TODO 1.1: Set pikachu's screen col here */) | ATTR1_SMALL;
