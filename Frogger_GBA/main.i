...
void goToStart() {
    DMANow(3, bgTiles, &((charblock *)0x6000000)[0], 12256 / 2 );
...
void goToGame() {
    DMANow(3, gameBgTiles, &((charblock *)0x6000000)[0], 5504 / 2 );
    DMANow(3, gameBgMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToPause() {
    ...
    DMANow(3, pausedbgTiles, &((charblock *)0x6000000)[0], 416 / 2 );
    DMANow(3, pausedbgMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    DMANow(3, pausedbgPal, ((unsigned short *)0x5000000), 512 / 2);
    state = PAUSE;
}
...
void goToWin() {
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    DMANow(3, winTiles, &((charblock *)0x6000000)[0], 256 / 2 );
...
void goToLose() {
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 480 / 2 );
