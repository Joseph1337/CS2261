...
void goToStart() {
    ...
    fillScreen(((18) | (19)<<5 | (27)<<10));



    char letters[8] = {'G', 'A', 'M', 'E', ' ', 'B', 'O', 'Y'};
    unsigned short colors[8] = {((22) | (6)<<5 | (13)<<10), ((28) | (8)<<5 | (16)<<10), ((31) | (13)<<5 | (21)<<10), ((31) | (20)<<5 | (26)<<10), ((18) | (19)<<5 | (27)<<10), ((5) | (26)<<5 | (25)<<10), ((0) | (21)<<5 | (20)<<10), ((0) | (16)<<5 | (16)<<10)};
    int col = 72;
    int spacing = 12;
    for(int i = 0; i < 8; i++){
    ...
    drawString(99, 96, "CS 2261", ((31) | (31)<<5 | (31)<<10));
...
void goToGame() {
    ...
    drawString(5, 145, "Ball Count: ", ((31) | (31)<<5 | (31)<<10));
...
void game() {
    ...
    drawRect(76, 145, 6, 8, 0);
    drawString(76, 145, buffer, ((31) | (31)<<5 | (31)<<10));
...
void goToPause() {
    ...
    fillScreen(((0) | (16)<<5 | (16)<<10));


    drawString(12, 12, "PAUSE", ((31) | (31)<<5 | (31)<<10));
    state = PAUSE;
}
...
void goToWin() {
    ...
    fillScreen(((17) | (27)<<5 | (31)<<10));


    drawString(12, 12, "WIN", ((31) | (31)<<5 | (31)<<10));
    state = WIN;
}
...
void goToLose() {
    ...
    fillScreen(((19) | (9)<<5 | (13)<<10));


    drawString(12, 12, "LOSE", ((31) | (31)<<5 | (31)<<10));
    state = LOSE;
}
